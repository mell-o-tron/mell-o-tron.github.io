...
shaders = [uniformShader, lightingShader]
...
Renderer.drawScene = function (gl) {
  ...
  inverse = glMatrix.mat4.create();
  glMatrix.mat4.invert(inverse, this.car.frame);
  
  gl.uniformMatrix4fv(this.shader.uFrame,false,inverse);
